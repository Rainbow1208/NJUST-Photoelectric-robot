...
{	 
  ...
  //GPIOFB3,4,5初始化设置
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_12|GPIO_Pin_13|GPIO_Pin_14;//PB3~5复用功能输出	
  ...
  GPIO_Init(GPIOE, &GPIO_InitStructure);//初始化
	...
	GPIO_PinAFConfig(GPIOE,GPIO_PinSource12,GPIO_AF_SPI4); //PB3复用为 SPI1
	GPIO_PinAFConfig(GPIOE,GPIO_PinSource13,GPIO_AF_SPI4); //PB4复用为 SPI1
	GPIO_PinAFConfig(GPIOE,GPIO_PinSource14,GPIO_AF_SPI4); //PB5复用为 SPI1
